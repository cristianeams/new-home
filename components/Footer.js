...
const ThemeSwitcher = () => {
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-gray-9=300 rounded-3xl p-1">
      <button
        type="button"
      ...
      <button
        ...
        className="flex items-center h-full pr-2 bg-primary dark:bg-primary rounded-3xl flex justify-center align-center p-2 w-24 h-10 transition dark:opacity-50"
      >
        {sunIcon}
      </button>
    </div>
